...
class TestBooksCollector:
    ...
    # get_book_genre
    def test_get_book_genre_for_book_from_books_genre_shows_book_genre(self, collector):
        collector.add_new_book('Солярис')
        collector.set_book_genre('Солярис', 'Фантастика')
    ...
    # get_books_genre
    def test_get_books_genre_shows_list_of_books_with_genres(self, collector):
        collector.add_new_book('Солярис')
        collector.set_book_genre('Солярис', 'Фантастика')
        books = {'Солярис': 'Фантастика'}
    ...
    def test_add_book_in_favorites_add_same_book_three_times_book_added_once(self, collector):
        collector.add_new_book('Солярис')
        collector.add_book_in_favorites('Солярис')
        collector.add_book_in_favorites('Солярис')
        collector.add_book_in_favorites('Солярис')
